...
This rule is covered by the [docdb-cluster-storage-encrypted](https://github.com/hashicorp/policy-library-iso-iec-27001-2013-annex-a-policy-set-for-aws-terraform/blob/main/policies/docdb/docdb-cluster-storage-encrypted.sentinel) policy.
