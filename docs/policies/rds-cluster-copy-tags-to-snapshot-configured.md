...
This rule is covered by the [rds-copy-tags-to-snapshot-configured](https://github.com/hashicorp/policy-library-iso-iec-27001-2013-annex-a-policy-set-for-aws-terraform/blob/main/policies/rds/rds-copy-tags-to-snapshot-configured.sentinel).
