...
This rule is covered by the [eks-cluster-endpoints-restrict-public-access](https://github.com/hashicorp/policy-library-iso-iec-27001-2013-annex-a-policy-set-for-aws-terraform/blob/main/policies/eks/eks-cluster-endpoints-restrict-public-access.sentinel) policy.
