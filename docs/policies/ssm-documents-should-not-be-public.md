...
This rule is covered by the [ssm-documents-should-not-be-public](https://github.com/hashicorp/policy-library-iso-iec-27001-2013-annex-a-policy-set-for-aws-terraform/blob/main/policies/ssm/ssm-documents-should-not-be-public.sentinel) policy.
