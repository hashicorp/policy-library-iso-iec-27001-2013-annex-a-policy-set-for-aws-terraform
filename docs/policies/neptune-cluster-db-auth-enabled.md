...
This rule is covered by the [neptune-cluster-db-auth-enabled](https://github.com/hashicorp/policy-library-iso-iec-27001-2013-annex-a-policy-set-for-aws-terraform/blob/main/policies/neptune/neptune-cluster-db-auth-enabled.sentinel) policy.
